...
>   * To ensure this, download the full OTA ROM (.zip) for your current OS version and local install it TWICE: local install, then reboot, then local install it AGAIN.
